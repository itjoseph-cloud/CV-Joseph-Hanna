...
4. If the resume changes, edit `scripts/create_resume_pdf.py`, regenerate the tagged PDF with Python, `python-docx`, and LibreOffice, render both pages, and visually inspect them.
