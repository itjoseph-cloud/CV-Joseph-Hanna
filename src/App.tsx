...
function Home() {
  return <>
    <section className="hero"><div className="shell hero-grid">
      ...
      <div className="portrait-wrap"><div className="portrait-frame"><img src="/CV-Joseph-Hanna/assets/joseph-hanna-headshot.webp" alt="Joseph Hanna, executive leader in IT strategy, cybersecurity, and modernization" width="640" height="640" /></div><div className="scope-card"><span>Recent business impact</span><strong>30% efficiency gain</strong><p>$500K+ savings enabled through secure, scalable modernization</p></div></div>
    </div></section>
